...
!-----------Added-----------
 ...
 double precision, allocatable :: rho(:), m_spin(:), zeta_m_n(:), g0(:), n2_UEG(:), n2_xc_UEG(:), ec_prime(:), ex_prime(:), beta_n_m_delta_n(:), delta_n_m_delta_n(:), gamma_n_m_delta_n(:) 
!---------------------------
...
!-----------Added------------
 allocate(rho(N_states), m_spin(N_states), zeta_m_n(N_states), g0(N_states), n2_UEG(N_states), n2_xc_UEG(N_states), ec_prime(N_states), ex_prime(N_states), beta_n_m_delta_n(N_states), delta_n_m_delta_n(N_states), gamma_n_m_delta_n(N_states))
!----------------------------
